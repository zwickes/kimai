...
<!--                <td class="rate"><a class="rate <?php /* if (isset($this->disabled_columns['rate'])):?> disabled <?php endif; ?>" onClick="export_toggle_column('rate');"><?php echo $this->kga['lang']['rate_short']?></a></td>
                ...
                <td class="approved <?php if (isset($this->disabled_columns['approved'])):?> disabled <?php endif; ?>"><a onClick="export_toggle_column('approved');"><?php echo $this->kga['lang']['approved']
 */
 ?></a></td>
 -->
...
<!--                  <a class="location <?php /*if (isset($this->disabled_columns['location'])):?> disabled <?php endif; ?>" onClick="export_toggle_column('location');"><?php echo $this->kga['lang']['location']?></a>,
	                <a class="trackingNumber <?php if (isset($this->disabled_columns['trackingNumber'])):?> disabled <?php endif; ?>" onClick="export_toggle_column('trackingNumber');"><?php echo $this->kga['lang']['trackingNumber']
*/
?></a>
-->
